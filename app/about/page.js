  ...
  return (
    <div className="bg-gray-900 text-white min-h-screen p-8">
      <section className="max-w-5xl mx-auto">
        <h1 className="text-3xl sm:text-4xl font-bold mb-4 sm:mb-6">About Get Me a Chai</h1>
        ...
        <section className="mb-4 sm:mb-8">
          ...
          <div className="flex items-start space-x-4">
            <div className="text-yellow-300">
              {/* Icon */}
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" className="w-6 sm:w-8 h-6 sm:h-8">
        ...
        <section className="mb-4 sm:mb-8">
          <h2 className="text-xl sm:text-2xl font-semibold mb-2 sm:mb-4">Benefits for Creators</h2>
        ...
        <section className="mb-4 sm:mb-8">
          <h2 className="text-xl sm:text-2xl font-semibold mb-2 sm:mb-4">Benefits for Fans</h2>
          <ul className="space-y-1 sm:space-y-2">
        ...
        <section className="mb-4 sm:mb-8">
          <h2 className="text-xl sm:text-2xl font-semibold mb-2 sm:mb-4">Benefits of Collaboration</h2>
          <ul className="space-y-1 sm:space-y-2">
        ...
        <section>
          <h2 className="text-xl sm:text-2xl font-semibold mb-2 sm:mb-4">Community Engagement</h2>
