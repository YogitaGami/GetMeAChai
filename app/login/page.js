...
const Login = () => {
  ...
  return (
    <>
      <h1 className="text-center text-2xl font-bold pt-20 pb-10">
        Login to Get Started
      </h1>
      <div className="flex justify-center items-center social-login-btn">
        <div className="flex flex-col gap-2 min-h-screen">
          <button className="flex items-center bg-white border border-gray-300 rounded-lg shadow-md max-w-xs px-10 py-2 text-sm font-medium text-gray-800 hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500">
            <svg
          ...
          <button className="flex items-center bg-white border border-gray-300 rounded-lg shadow-md max-w-xs px-10 py-2 text-sm font-medium text-gray-800 hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500">
            ...
            <span className="text-black">Continue with LinkedIn</span>
          </button>
          ...
          <button onClick={()=>{signIn("github")}} className="flex items-center bg-white border border-gray-300 rounded-lg shadow-md max-w-xs px-10 py-2 text-sm font-medium text-gray-800 hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500">
            <svg
              className="h-6 w-6 mr-2"
              xmlns="http://www.w3.org/2000/svg"
              xmlnsXlink="http://www.w3.org/1999/xlink"
